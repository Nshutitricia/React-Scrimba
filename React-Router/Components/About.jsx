export default function About(){
    ...
    return(
        <section>
            ...
            <h1 className=" mx-auto  w-[80%] text-[32px] font-bold mt-10">Don’t squeeze in a sedan when you could relax in a van.</h1>
            ...
            <div className="mx-auto  w-[80%] bg-[#FFCC8D] font-bold mt-10  rounded-lg">
